...
const projects: DevelopmentProject[] = [
  ...
  },
  {
    ...
    progress: 42,
    currentStage: '인증 기반',
    summary: 'NestJS, PostgreSQL 14, Prisma와 Better Auth 기반 Groupware SSO 인증을 구축하고 있습니다.',
    updates: ['Groupware postMessage 인증 연결', 'DB session 및 관리자 권한 기반 추가'],
    nextActions: ['migration 및 E2E 검증', '도메인 API schema 확장'],
  },
  {
    id: 'toggle-ux',
