...
export const mockGroups: CompoundGroup[] = [
  ...
  {
    id: 'g4',
    name: 'C1CC1(C(=O)NC2=CC=C(C=C2)OC3=C4C=C(NC4=NC=C3)C(=O)NCCN5CCOCC5)C(=O)NC6=CC=C(C=C6)F',
    type: 'my compounds',
    count: 1,
    creDate: '2026.06.01',
    target: '-',
  ...
  {
    id: 'g5',
    name: 'CC1=CC(=C(C=C1N2CCC(CC2)N3CCN(CC3)C)OC)NC4=NC=C(C(=N4)NC5=C(C6=NC=CN=C6C=C5)P(=O)(C)C)Br',
    type: 'my compounds',
    count: 1,
    creDate: '2026.06.01',
    target: '-',
...
export const mockCompounds: Compound[] = [
  ...
  ),
  {
    ...
    designNo: 'D-MB-001',
    designMemo: '사용자 요청으로 MyBoard 그룹 리스트에 추가한 단일 mock 화합물',
    requiredAmountMg: 10,
