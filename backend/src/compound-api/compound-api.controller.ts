...
export class CompoundApiController {
  ...
  async searchCompounds(@Session() session: UserSession, @Body() body: SearchCompoundsDto) {
  ...
  @Post('get-compounds')
  async getCompounds(@Session() session: UserSession, @Body() body: GetCompoundsDto) {
  ...
  async getCompoundSarData(@Session() session: UserSession, @Body() body: GetCompoundSarDataDto) {
  ...
  async getCompoundCalculate(@Session() session: UserSession, @Body() body: GetCompoundCalculateDto) {
